"""Create GitHub Release v1.1.4 with the .zip asset.

Uploads release/VoidHunter-v1.1.4-win64.zip to a new GitHub Release
on tag v1.1.4, with release notes extracted from CHANGELOG.md.
...
TAG = "v1.1.4"
ZIP_PATH = Path(r"D:\AI\void-hunter\release\VoidHunter-v1.1.4-win64.zip")
...
def get_release_notes() -> str:
    """Extract the [v1.1.4] section from CHANGELOG.md."""
