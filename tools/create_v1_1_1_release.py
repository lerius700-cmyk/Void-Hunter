"""Create GitHub Release v1.1.1 with the .zip asset.

Uploads release/VoidHunter-v1.1.1-win64.zip to a new GitHub Release
on tag v1.1.1, with release notes extracted from CHANGELOG.md.
...
TAG = "v1.1.1"
ZIP_PATH = Path(r"D:\AI\void-hunter\release\VoidHunter-v1.1.1-win64.zip")
...
def get_release_notes() -> str:
    """Extract the [v1.1.1] section from CHANGELOG.md."""
