...
6 patterns inspired by Star Fox 64:
  ...
  6. OSCILLATING_BUTTERFLY - orbital "breathing" swarm (BLOQUE 58.11)
...
def make_pattern(kind: WavePatternKind) -> WavePattern:
    ...
    mapping = {
        ...
        WavePatternKind.OSCILLATING_BUTTERFLY: OscillatingButterflyPattern,
    }
    return mapping[kind]()
